...
- Leadership :: 29 years of team and project leadership experience; systems architecture; [[https://www.scaledagile.com/][Scaled Agile Framework (SAFe)]] methodology and processes.
- Computer Security :: Enterprise security architecture; risk management; intrusion detection and prevention (Ph.D. in this area); operating systems and network security; software security and secure software development; virtualization and cloud computing security; CISSP.
...
- Languages :: Spanish (native), English (100%), German (60%).

* Key professional achievements

#+latex: \begin{cvparagraph}
- Responsible for security architecture, risk management and compliance of Swisscom's IT Clouds platforms and related services and components.
...
- Managed the CFEngine language roadmap, including discussions with internal stakeholders, customers and community.
- Managed relationships at HP Enterprise Services with multiple large customers in the area of security. This included overseeing the activities of operational and engineering teams, risk and compliance management, requirements discussion and reporting.
- Established and led the first incident response team at UNAM, which has grown into the university's [[https://www.seguridad.unam.mx/][Coordination of Information Security/UNAM-CERT]].
- Designed and implemented the /Billy Goat/ malware analysis system at IBM.
- Was in charge of system administration and security monitoring for UNAM's Cray Y-MP supercomputer and 22 subsidiary Unix workstations.
...
- Designed and implemented the first version of the [[https://docs.cfengine.com/docs/3.10/guide-design-center.html][CFEngine Design Center]], which is now a key component of CFEngine Enterprise.
- Was [[#program-committees][program chair and program committee member for multiple conferences]] including RAID symposium, DIMVA conference, the first instances of the /International Computer Security Day/ and the /Computer Security/ conference at UNAM, and others.
- Was member of the Editorial Board of the Computers & Security Journal.
#+latex: \end{cvparagraph}
