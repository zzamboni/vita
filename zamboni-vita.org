...
#+title: IT Security Architect · Computer Scientist · Team and Project Leader
...
#+latex: \nocite{*}
#+latex: \printbibliography[keyword=book,          heading=cvbibsection, title=Books]
#+latex: \printbibliography[keyword=editorial,     heading=cvbibsection, title=Editorial Activities]
#+latex: \printbibliography[keyword=thesis,        heading=cvbibsection, title=Theses]
#+latex: \printbibliography[keyword=refereed,      heading=cvbibsection, title=Refereed Papers]
#+latex: \printbibliography[keyword=techreport,    heading=cvbibsection, title=Tech Reports]
#+latex: \printbibliography[keyword=presentations, heading=cvbibsection, title=Presentations at Conferences and Workshops]
#+latex: \printbibliography[keyword=invited,       heading=cvbibsection, title=Invited Talks and Articles]
#+latex: \printbibliography[keyword=patent,        heading=cvbibsection, title=Patents]
#+latex: \printbibliography[keyword=other,         heading=cvbibsection, title=Other Publications]
