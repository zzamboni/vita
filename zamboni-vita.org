...
:RIGHT_IMG: ./images/aws-certified-sysops-administrator-associate-small.png
:END:

#+begin_cvitems
Earners of this certification have a comprehensive understanding on how to deploy, manage, and operate IT systems on the AWS Cloud. They demonstrated the ability to migrate on-premises workloads to AWS and monitor, scale, and secure systems on the AWS platform. They are able to provide guidance on implementing best practices for cloud operations.
#+end_cvitems
